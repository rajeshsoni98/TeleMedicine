...
public class SessionManager {
    ...
    private static final String PREF_NAME = "TeleMedicine";
    ...
    public String getBaseUrl() {
        return pref.getString(BASE_URL, "https://openmrs.TeleMedicine.io");
    }
    ...
    public String getMindMapServerUrl() {
        return pref.getString(MIND_MAP_SERVER_URL, "https://mindmaps2.TeleMedicine.io");
    }  //getting the sync value  and time and saving in the sharedpref
