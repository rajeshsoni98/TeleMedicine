package app.telemedicine.client.app;
...
import app.telemedicine.client.syncModule.LastSyncWork;
import app.telemedicine.client.syncModule.VisitSummaryWork;
import app.telemedicine.client.utilities.DateAndTimeUtils;
import app.telemedicine.client.utilities.NotificationUtils;
...
import app.telemedicine.client.syncModule.SyncWorkManager;
...
public class AppConstants {
    ...
    public static final String dbfilepath = Environment.getExternalStorageDirectory() + File.separator + "InteleHealth_DB" + File.separator + "TeleMedicine.db"; // directory: Intelehealth_DB   ,  filename: TeleMedicine.db
