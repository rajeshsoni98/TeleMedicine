package app.telemedicine.client.activities.familyHistoryActivity;
...
import app.telemedicine.client.activities.questionNodeActivity.QuestionsAdapter;
...
import app.telemedicine.client.utilities.pageindicator.ScrollingPagerIndicator;
...
//        if (sessionManager.getLicenseKey() != null && !sessionManager.getLicenseKey().isEmpty())
    ...
    public boolean insertDb(String value) {
        ...
        obsDTO.setValue(app.telemedicine.client.utilities.StringUtils.getValue(value));
