package app.telemedicine.client.activities.visitSummaryActivity;
...
import app.telemedicine.client.activities.additionalDocumentsActivity.AdditionalDocumentsActivity;
import app.telemedicine.client.activities.complaintNodeActivity.ComplaintNodeActivity;
import app.telemedicine.client.activities.familyHistoryActivity.FamilyHistoryActivity;
import app.telemedicine.client.activities.pastMedicalHistoryActivity.PastMedicalHistoryActivity;
import app.telemedicine.client.activities.patientSurveyActivity.PatientSurveyActivity;
import app.telemedicine.client.app.AppConstants;
import app.telemedicine.client.app.IntelehealthApplication;
import app.telemedicine.client.database.dao.EncounterDAO;
import app.telemedicine.client.database.dao.ImagesDAO;
import app.telemedicine.client.database.dao.ObsDAO;
import app.telemedicine.client.database.dao.PatientsDAO;
import app.telemedicine.client.database.dao.SyncDAO;
import app.telemedicine.client.database.dao.VisitsDAO;
import app.telemedicine.client.knowledgeEngine.Node;
import app.telemedicine.client.models.ClsDoctorDetails;
import app.telemedicine.client.models.Patient;
import app.telemedicine.client.models.dto.ObsDTO;
import app.telemedicine.client.services.DownloadService;
import app.telemedicine.client.syncModule.SyncUtils;
import app.telemedicine.client.utilities.DateAndTimeUtils;
import app.telemedicine.client.utilities.FileUtils;
import app.telemedicine.client.utilities.Logger;
import app.telemedicine.client.utilities.SessionManager;
import app.telemedicine.client.utilities.UuidDictionary;

import app.telemedicine.client.activities.homeActivity.HomeActivity;
import app.telemedicine.client.activities.physcialExamActivity.PhysicalExamActivity;
import app.telemedicine.client.activities.vitalActivity.VitalsActivity;
import app.telemedicine.client.utilities.NetworkConnection;
import app.telemedicine.client.utilities.exception.DAOException;
...
public class VisitSummaryActivity extends AppCompatActivity {
    ...
    public static final String FILTER = "io.telemedicine.client.activities.visit_summary_activity.REQUEST_PROCESSED";
