package app.telemedicine.client.activities.loginActivity;
...
//                        intent.setData(Uri.parse("mailto:support@TeleMedicine.io"));
//                        // intent.putExtra(Intent.EXTRA_EMAIL, "support@telemedicine.io");
...
//                                                success = true;
                                          /*  final Account account = new Account(mEmail, "io.telemedicine.openmrs");
