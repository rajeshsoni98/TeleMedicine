package app.telemedicine.client.activities.homeActivity;
...
import app.telemedicine.client.activities.activePatientsActivity.ActivePatientActivity;
import app.telemedicine.client.activities.identificationActivity.IdentificationActivity;
import app.telemedicine.client.activities.loginActivity.LoginActivity;
import app.telemedicine.client.activities.privacyNoticeActivity.PrivacyNotice_Activity;
import app.telemedicine.client.activities.searchPatientActivity.SearchPatientActivity;
import app.telemedicine.client.activities.settingsActivity.SettingsActivity;
import app.telemedicine.client.activities.todayPatientActivity.TodayPatientActivity;
import app.telemedicine.client.activities.videoLibraryActivity.VideoLibraryActivity;
import app.telemedicine.client.app.AppConstants;
import app.telemedicine.client.app.IntelehealthApplication;
import app.telemedicine.client.models.CheckAppUpdateRes;
import app.telemedicine.client.models.DownloadMindMapRes;
...
import app.telemedicine.client.utilities.ConfigUtils;
import app.telemedicine.client.utilities.DownloadMindMaps;
import app.telemedicine.client.utilities.Logger;
import app.telemedicine.client.utilities.NetworkConnection;
import app.telemedicine.client.utilities.OfflineLogin;
import app.telemedicine.client.utilities.SessionManager;
import app.telemedicine.client.widget.materialprogressbar.CustomProgressDialog;
...
//        parseLogOut();
     ...
     /*   Account[] accountList = manager.getAccountsByType("io.telemedicine.openmrs");
