package app.telemedicine.client.activities.identificationActivity;
...
import app.telemedicine.client.activities.patientDetailActivity.PatientDetailActivity;
...
import app.telemedicine.client.database.dao.ImagesPushDAO;
...
import app.telemedicine.client.models.dto.PatientAttributesDTO;
import app.telemedicine.client.models.dto.PatientDTO;
import app.telemedicine.client.utilities.DateAndTimeUtils;
import app.telemedicine.client.utilities.EditTextUtils;
import app.telemedicine.client.utilities.FileUtils;
import app.telemedicine.client.utilities.IReturnValues;
import app.telemedicine.client.utilities.Logger;
import app.telemedicine.client.utilities.SessionManager;
import app.telemedicine.client.utilities.UuidGenerator;

import app.telemedicine.client.activities.cameraActivity.CameraActivity;
...
import app.telemedicine.client.utilities.StringUtils;
        ...
        mCountry.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (i != 0) {
                    ...
                    else if (country.matches("Guinée")) {
                        ArrayAdapter<CharSequence> stateAdapter = ArrayAdapter.createFromResource(IdentificationActivity.this,
                                R.array.states_Guinée, R.layout.custom_spinner);
                        // stateAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                        mState.setAdapter(stateAdapter);
                        // setting state according database when user clicks edit details
