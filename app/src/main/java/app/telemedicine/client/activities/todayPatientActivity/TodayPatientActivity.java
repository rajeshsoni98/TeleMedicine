package app.telemedicine.client.activities.todayPatientActivity;
...
import app.telemedicine.client.database.dao.ProviderDAO;
import app.telemedicine.client.database.dao.VisitsDAO;
import app.telemedicine.client.models.TodayPatientModel;
...
public class TodayPatientActivity extends AppCompatActivity {
   ...
   MaterialAlertDialogBuilder dialogBuilder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getResources().getString(R.string.title_activity_today_patient));
